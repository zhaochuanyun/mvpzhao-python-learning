...
"""
https://blog.csdn.net/csdnnews/article/details/89391652#commentsedit
"""
class CharFrame:
...
if __name__ == '__main__':
    v2char = V2Char('/Users/mvpzhao/tools/python-workspace/mvpzhao-python-learning/samples/basketball/vedio.mp4')
    v2char.play()
